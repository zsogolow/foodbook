...
public class MainActivity1 extends TokenActivity implements IActivityCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _rtbtn.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                new RefreshTokenAsyncTask(MainActivity1.this, mRefreshCallback, mToken).execute();
            }
        });
        ...
        _uibtn.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                new UserInfoAsyncTask(MainActivity1.this, mUserInfoCallback, mToken).execute();
            }
        });
        ...
        _cabtn.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                new CallServiceAsyncTask(MainActivity1.this, mGetUsersCallback, mToken).execute("api/users");
            }
        });
        ...
        _atbtn.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                new CallServiceAsyncTask(MainActivity1.this, mGetUserCallback, mToken).execute("api/users/" + mUserSubject);
            }
        });
...
//        filter=((DateCreated Ge 2017-05-16 00:00:00 -0700) And (DateCreated Le 2017-05-16 23:59:59 -0700))
        ...
        _gnbtn.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                new CallServiceAsyncTask(MainActivity1.this, mGetMyNotesCallback, mToken).execute("api/users/" + mUserSubject + "/notes");
            }
        });
        ...
        _cnbtn.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                ...
                new PostServiceAsyncTask(MainActivity1.this, mCreateNoteCallback, mToken, map).execute("api/notes");
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_logout:
                // User chose the "Settings" item, show the app settings UI...
                SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(MainActivity1.this);
